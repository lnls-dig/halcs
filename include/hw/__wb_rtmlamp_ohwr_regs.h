...
#define RTMLAMP_OHWR_REGS_SIZE 420 /* 0x1a4 */
...
/* PI KP parameter */
#define RTMLAMP_OHWR_REGS_PI_KP 0x190UL
#define RTMLAMP_OHWR_REGS_PI_KP_DATA_MASK 0xffffffffUL
#define RTMLAMP_OHWR_REGS_PI_KP_DATA_SHIFT 0

/* PI TI parameter */
#define RTMLAMP_OHWR_REGS_PI_TI 0x194UL
#define RTMLAMP_OHWR_REGS_PI_TI_DATA_MASK 0xffffffffUL
#define RTMLAMP_OHWR_REGS_PI_TI_DATA_SHIFT 0

/* PI Setpoint parameter */
#define RTMLAMP_OHWR_REGS_PI_SP 0x198UL
#define RTMLAMP_OHWR_REGS_PI_SP_DATA_MASK 0xffffffffUL
#define RTMLAMP_OHWR_REGS_PI_SP_DATA_SHIFT 0

/* PI open-loop DAC test mode period, in clock ticks.
This defines the period of open-loop test waveforms
 */
#define RTMLAMP_OHWR_REGS_PI_OL_DAC_CNT_MAX 0x19cUL
 ...
 */
#define RTMLAMP_OHWR_REGS_PI_SP_LIM_INF 0x1a0UL
...
struct rtmlamp_ohwr_regs {
  ...
  /* [0x190]: REG (rw) PI KP parameter */
  uint32_t pi_kp;

  /* [0x194]: REG (rw) PI TI parameter */
  uint32_t pi_ti;

  /* [0x198]: REG (rw) PI Setpoint parameter */
  uint32_t pi_sp;

  /* [0x19c]: REG (rw) PI open-loop DAC test mode period, in clock ticks.
This defines the period of open-loop test waveforms
 */
  uint32_t pi_ol_dac_cnt_max;

  /* [0x1a0]: REG (rw) PI open-loop DAC test mode inferior limit. The upper limit is the setpoint itself.
 */
