...
#define RTMLAMP_OHWR_REG_CH_0_PI_KP                  RTMLAMP_OHWR_REGS_CH_0_PI_KP

/* Definitions for PI KP parameter */
#define RTMLAMP_OHWR_CH_0_PI_KP_DATA_MASK            RTMLAMP_OHWR_REGS_CH_0_PI_KP_DATA_MASK
#define RTMLAMP_OHWR_CH_0_PI_KP_DATA_SHIFT           RTMLAMP_OHWR_REGS_CH_0_PI_KP_DATA_SHIFT
#define RTMLAMP_OHWR_CH_0_PI_KP_DATA_R(val)          ((val & RTMLAMP_OHWR_CH_0_PI_KP_DATA_MASK) >> RTMLAMP_OHWR_CH_0_PI_KP_DATA_SHIFT)
#define RTMLAMP_OHWR_CH_0_PI_KP_DATA_W(val)          ((val & RTMLAMP_OHWR_CH_0_PI_KP_DATA_MASK) << RTMLAMP_OHWR_CH_0_PI_KP_DATA_SHIFT)

#define RTMLAMP_OHWR_REG_CH_0_PI_TI                  RTMLAMP_OHWR_REGS_CH_0_PI_TI

/* Definitions for PI KP parameter */
#define RTMLAMP_OHWR_CH_0_PI_TI_DATA_MASK            RTMLAMP_OHWR_REGS_CH_0_PI_TI_DATA_MASK
#define RTMLAMP_OHWR_CH_0_PI_TI_DATA_SHIFT           RTMLAMP_OHWR_REGS_CH_0_PI_TI_DATA_SHIFT
#define RTMLAMP_OHWR_CH_0_PI_TI_DATA_R(val)          ((val & RTMLAMP_OHWR_CH_0_PI_TI_DATA_MASK) >> RTMLAMP_OHWR_CH_0_PI_TI_DATA_SHIFT)
#define RTMLAMP_OHWR_CH_0_PI_TI_DATA_W(val)          ((val & RTMLAMP_OHWR_CH_0_PI_TI_DATA_MASK) << RTMLAMP_OHWR_CH_0_PI_TI_DATA_SHIFT)

#define RTMLAMP_OHWR_REG_CH_0_PI_SP                  RTMLAMP_OHWR_REGS_CH_0_PI_SP

/* Definitions for PI KP parameter */
#define RTMLAMP_OHWR_CH_0_PI_SP_DATA_MASK            RTMLAMP_OHWR_REGS_CH_0_PI_SP_DATA_MASK
#define RTMLAMP_OHWR_CH_0_PI_SP_DATA_SHIFT           RTMLAMP_OHWR_REGS_CH_0_PI_SP_DATA_SHIFT
#define RTMLAMP_OHWR_CH_0_PI_SP_DATA_R(val)          ((val & RTMLAMP_OHWR_CH_0_PI_SP_DATA_MASK) >> RTMLAMP_OHWR_CH_0_PI_SP_DATA_SHIFT)
#define RTMLAMP_OHWR_CH_0_PI_SP_DATA_W(val)          ((val & RTMLAMP_OHWR_CH_0_PI_SP_DATA_MASK) << RTMLAMP_OHWR_CH_0_PI_SP_DATA_SHIFT)
