...
#define WB_RTMLAMP_OHWR_STA_RESERVED_W(val)          ((val << WB_RTMLAMP_OHWR_STA_RESERVED_SHIFT) & WB_RTMLAMP_OHWR_STA_RESERVED_MASK)
...
#define WB_RTMLAMP_OHWR_REG_CH_CTL                   WB_RTMLAMP_OHWR_REGS_CH_CTL + WB_RTMLAMP_OHWR_REGS_CH
#define WB_RTMLAMP_OHWR_CH_CTL_AMP_EN                WB_RTMLAMP_OHWR_REGS_CH_CTL_AMP_EN
#define WB_RTMLAMP_OHWR_CH_CTL_TRIG_EN               WB_RTMLAMP_OHWR_REGS_CH_CTL_TRIG_EN
...
#define WB_RTMLAMP_OHWR_CH_CTL_MODE_W(val)           ((val << WB_RTMLAMP_OHWR_CH_CTL_MODE_SHIFT) & WB_RTMLAMP_OHWR_CH_CTL_MODE_MASK)

/* Definitions for PI Kp parameter */
#define WB_RTMLAMP_OHWR_REG_CH_PI_KP                 WB_RTMLAMP_OHWR_REGS_CH_PI_KP + WB_RTMLAMP_OHWR_REGS_CH
...
#define WB_RTMLAMP_OHWR_CH_PI_KP_DATA_W(val)         ((val << WB_RTMLAMP_OHWR_CH_PI_KP_DATA_SHIFT) & WB_RTMLAMP_OHWR_CH_PI_KP_DATA_MASK)

/* Definitions for PI Ti parameter */
#define WB_RTMLAMP_OHWR_REG_CH_PI_TI                 WB_RTMLAMP_OHWR_REGS_CH_PI_TI + WB_RTMLAMP_OHWR_REGS_CH
...
#define WB_RTMLAMP_OHWR_CH_PI_TI_DATA_W(val)         ((val << WB_RTMLAMP_OHWR_CH_PI_TI_DATA_SHIFT) & WB_RTMLAMP_OHWR_CH_PI_TI_DATA_MASK)

/* Definitions for PI SP parameter */
#define WB_RTMLAMP_OHWR_REG_CH_PI_SP                 WB_RTMLAMP_OHWR_REGS_CH_PI_SP + WB_RTMLAMP_OHWR_REGS_CH
...
#define WB_RTMLAMP_OHWR_CH_PI_SP_DATA_W(val)         ((val << WB_RTMLAMP_OHWR_CH_PI_SP_DATA_SHIFT) & WB_RTMLAMP_OHWR_CH_PI_SP_DATA_MASK)

/* Definitions for DAC Channel control register */
#define WB_RTMLAMP_OHWR_REG_CH_DAC                   WB_RTMLAMP_OHWR_REGS_CH_DAC + WB_RTMLAMP_OHWR_REGS_CH
...
#define WB_RTMLAMP_OHWR_CH_DAC_DATA_W(val)           ((val << WB_RTMLAMP_OHWR_CH_DAC_DATA_SHIFT) & WB_RTMLAMP_OHWR_CH_DAC_DATA_MASK)

/* Definitions for square wave limits */
#define WB_RTMLAMP_OHWR_REG_CH_LIM                   WB_RTMLAMP_OHWR_REGS_CH_LIM + WB_RTMLAMP_OHWR_REGS_CH
...
#define WB_RTMLAMP_OHWR_CH_LIM_A_W(val)              ((val << WB_RTMLAMP_OHWR_CH_LIM_A_SHIFT) & WB_RTMLAMP_OHWR_CH_LIM_A_MASK)
#define WB_RTMLAMP_OHWR_CH_LIM_B_MASK                WB_RTMLAMP_OHWR_REGS_CH_LIM_B_MASK
#define WB_RTMLAMP_OHWR_CH_LIM_B_SHIFT               WB_RTMLAMP_OHWR_REGS_CH_LIM_B_SHIFT
#define WB_RTMLAMP_OHWR_CH_LIM_B_R(val)              ((val & WB_RTMLAMP_OHWR_CH_LIM_B_MASK) >> WB_RTMLAMP_OHWR_CH_LIM_B_SHIFT)
#define WB_RTMLAMP_OHWR_CH_LIM_B_W(val)              ((val << WB_RTMLAMP_OHWR_CH_LIM_B_SHIFT) & WB_RTMLAMP_OHWR_CH_LIM_B_MASK)

/* Definitions for test mode period (in clock ticks) */
#define WB_RTMLAMP_OHWR_REG_CH_CNT                   WB_RTMLAMP_OHWR_REGS_CH_CNT + WB_RTMLAMP_OHWR_REGS_CH
...
#define WB_RTMLAMP_OHWR_CH_CNT_DATA_W(val)           ((val << WB_RTMLAMP_OHWR_CH_CNT_DATA_SHIFT) & WB_RTMLAMP_OHWR_CH_CNT_DATA_MASK)

/* Definitions for ADC and DAC instantaneous value (2's complement) */
#define WB_RTMLAMP_OHWR_REG_CH_ADC_DAC_EFF           WB_RTMLAMP_OHWR_REGS_CH_ADC_DAC_EFF + WB_RTMLAMP_OHWR_REGS_CH
...
#define WB_RTMLAMP_OHWR_CH_ADC_DAC_EFF_ADC_W(val)    ((val << WB_RTMLAMP_OHWR_CH_ADC_DAC_EFF_ADC_SHIFT) & WB_RTMLAMP_OHWR_CH_ADC_DAC_EFF_ADC_MASK)
#define WB_RTMLAMP_OHWR_CH_ADC_DAC_EFF_DAC_MASK      WB_RTMLAMP_OHWR_REGS_CH_ADC_DAC_EFF_DAC_MASK
#define WB_RTMLAMP_OHWR_CH_ADC_DAC_EFF_DAC_SHIFT     WB_RTMLAMP_OHWR_REGS_CH_ADC_DAC_EFF_DAC_SHIFT
...
#define WB_RTMLAMP_OHWR_CH_ADC_DAC_EFF_DAC_W(val)    ((val << WB_RTMLAMP_OHWR_CH_ADC_DAC_EFF_DAC_SHIFT) & WB_RTMLAMP_OHWR_CH_ADC_DAC_EFF_DAC_MASK)

/* Definitions for setpoint instantaneous value (2's complement) */
#define WB_RTMLAMP_OHWR_REG_CH_SP_EFF                WB_RTMLAMP_OHWR_REGS_CH_SP_EFF + WB_RTMLAMP_OHWR_REGS_CH
...
#define WB_RTMLAMP_OHWR_CH_SP_EFF_SP_W(val)          ((val << WB_RTMLAMP_OHWR_CH_SP_EFF_SP_SHIFT) & WB_RTMLAMP_OHWR_CH_SP_EFF_SP_MASK)
