...
#define POS_CALC_REG_ADC_GAINS_FIXED_POINT_POS 0x11cUL
/* ADC channel 0 gain on RFFE switch state 0 (inverted) */
#define POS_CALC_REG_ADC_CH0_SWCLK_0_GAIN 0x120UL
/* ADC channel 1 gain on RFFE switch state 0 (inverted) */
#define POS_CALC_REG_ADC_CH1_SWCLK_0_GAIN 0x124UL
/* ADC channel 2 gain on RFFE switch state 0 (inverted) */
#define POS_CALC_REG_ADC_CH2_SWCLK_0_GAIN 0x128UL
/* ADC channel 3 gain on RFFE switch state 0 (inverted) */
#define POS_CALC_REG_ADC_CH3_SWCLK_0_GAIN 0x12cUL
/* ADC channel 0 gain on RFFE switch state 1 (direct) */
#define POS_CALC_REG_ADC_CH0_SWCLK_1_GAIN 0x130UL
/* ADC channel 1 gain on RFFE switch state 1 (direct) */
#define POS_CALC_REG_ADC_CH1_SWCLK_1_GAIN 0x134UL
/* ADC channel 2 gain on RFFE switch state 1 (direct) */
#define POS_CALC_REG_ADC_CH2_SWCLK_1_GAIN 0x138UL
/* ADC channel 3 gain on RFFE switch state 1 (direct) */
#define POS_CALC_REG_ADC_CH3_SWCLK_1_GAIN 0x13cUL
#endif
