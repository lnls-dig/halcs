...
#ifndef __WBGEN2_DSP_MACROS_DEFINED__
#define __WBGEN2_DSP_MACROS_DEFINED__
#define WBGEN2_DSP_GEN_MASK(offset, size) ((((uint64_t)1<<(size))-1) << (offset))
#define WBGEN2_DSP_GEN_WRITE(value, offset, size) (((value) & (((uint64_t)1<<(size))-1)) << (offset))
#define WBGEN2_DSP_GEN_READ(reg, offset, size) (((reg) >> (offset)) & (((uint64_t)1<<(size))-1))
#define WBGEN2_DSP_SIGN_EXTEND(value, bits) (((value) & ((uint64_t)1<<bits) ? ~(((uint64_t)1<<(bits))-1): 0 ) | (value))
#endif
...
#define POS_CALC_DS_TBT_THRES_VAL_MASK        WBGEN2_DSP_GEN_MASK(0, 26)
#define POS_CALC_DS_TBT_THRES_VAL_SHIFT       0
#define POS_CALC_DS_TBT_THRES_VAL_W(value)    WBGEN2_DSP_GEN_WRITE(value, 0, 26)
#define POS_CALC_DS_TBT_THRES_VAL_R(reg)      WBGEN2_DSP_GEN_READ(reg, 0, 26)

/* definitions for field: Reserved in reg: Config divisor threshold TBT register */
#define POS_CALC_DS_TBT_THRES_RESERVED_MASK   WBGEN2_DSP_GEN_MASK(26, 6)
#define POS_CALC_DS_TBT_THRES_RESERVED_SHIFT  26
#define POS_CALC_DS_TBT_THRES_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 26, 6)
#define POS_CALC_DS_TBT_THRES_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 26, 6)
...
#define POS_CALC_DS_FOFB_THRES_VAL_MASK       WBGEN2_DSP_GEN_MASK(0, 26)
#define POS_CALC_DS_FOFB_THRES_VAL_SHIFT      0
#define POS_CALC_DS_FOFB_THRES_VAL_W(value)   WBGEN2_DSP_GEN_WRITE(value, 0, 26)
#define POS_CALC_DS_FOFB_THRES_VAL_R(reg)     WBGEN2_DSP_GEN_READ(reg, 0, 26)

/* definitions for field: Reserved in reg: Config divisor threshold FOFB register */
#define POS_CALC_DS_FOFB_THRES_RESERVED_MASK  WBGEN2_DSP_GEN_MASK(26, 6)
#define POS_CALC_DS_FOFB_THRES_RESERVED_SHIFT 26
#define POS_CALC_DS_FOFB_THRES_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 26, 6)
#define POS_CALC_DS_FOFB_THRES_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 26, 6)
...
#define POS_CALC_DS_MONIT_THRES_VAL_MASK      WBGEN2_DSP_GEN_MASK(0, 26)
#define POS_CALC_DS_MONIT_THRES_VAL_SHIFT     0
#define POS_CALC_DS_MONIT_THRES_VAL_W(value)  WBGEN2_DSP_GEN_WRITE(value, 0, 26)
#define POS_CALC_DS_MONIT_THRES_VAL_R(reg)    WBGEN2_DSP_GEN_READ(reg, 0, 26)

/* definitions for field: Reserved in reg: Config divisor threshold Monit. register */
#define POS_CALC_DS_MONIT_THRES_RESERVED_MASK WBGEN2_DSP_GEN_MASK(26, 6)
#define POS_CALC_DS_MONIT_THRES_RESERVED_SHIFT 26
#define POS_CALC_DS_MONIT_THRES_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 26, 6)
#define POS_CALC_DS_MONIT_THRES_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 26, 6)
...
#define POS_CALC_KX_VAL_MASK                  WBGEN2_DSP_GEN_MASK(0, 25)
#define POS_CALC_KX_VAL_SHIFT                 0
#define POS_CALC_KX_VAL_W(value)              WBGEN2_DSP_GEN_WRITE(value, 0, 25)
#define POS_CALC_KX_VAL_R(reg)                WBGEN2_DSP_GEN_READ(reg, 0, 25)

/* definitions for field: Reserved in reg: BPM sensitivity (X axis) parameter register */
#define POS_CALC_KX_RESERVED_MASK             WBGEN2_DSP_GEN_MASK(25, 7)
#define POS_CALC_KX_RESERVED_SHIFT            25
#define POS_CALC_KX_RESERVED_W(value)         WBGEN2_DSP_GEN_WRITE(value, 25, 7)
#define POS_CALC_KX_RESERVED_R(reg)           WBGEN2_DSP_GEN_READ(reg, 25, 7)
...
#define POS_CALC_KY_VAL_MASK                  WBGEN2_DSP_GEN_MASK(0, 25)
#define POS_CALC_KY_VAL_SHIFT                 0
#define POS_CALC_KY_VAL_W(value)              WBGEN2_DSP_GEN_WRITE(value, 0, 25)
#define POS_CALC_KY_VAL_R(reg)                WBGEN2_DSP_GEN_READ(reg, 0, 25)

/* definitions for field: Reserved in reg: BPM sensitivity (Y axis) parameter register */
#define POS_CALC_KY_RESERVED_MASK             WBGEN2_DSP_GEN_MASK(25, 7)
#define POS_CALC_KY_RESERVED_SHIFT            25
#define POS_CALC_KY_RESERVED_W(value)         WBGEN2_DSP_GEN_WRITE(value, 25, 7)
#define POS_CALC_KY_RESERVED_R(reg)           WBGEN2_DSP_GEN_READ(reg, 25, 7)
...
#define POS_CALC_KSUM_VAL_MASK                WBGEN2_DSP_GEN_MASK(0, 25)
#define POS_CALC_KSUM_VAL_SHIFT               0
#define POS_CALC_KSUM_VAL_W(value)            WBGEN2_DSP_GEN_WRITE(value, 0, 25)
#define POS_CALC_KSUM_VAL_R(reg)              WBGEN2_DSP_GEN_READ(reg, 0, 25)

/* definitions for field: Reserved in reg: BPM sensitivity (Sum) parameter register */
#define POS_CALC_KSUM_RESERVED_MASK           WBGEN2_DSP_GEN_MASK(25, 7)
#define POS_CALC_KSUM_RESERVED_SHIFT          25
#define POS_CALC_KSUM_RESERVED_W(value)       WBGEN2_DSP_GEN_WRITE(value, 25, 7)
#define POS_CALC_KSUM_RESERVED_R(reg)         WBGEN2_DSP_GEN_READ(reg, 25, 7)
...
#define POS_CALC_DSP_CTNR_TBT_CH01_MASK       WBGEN2_DSP_GEN_MASK(0, 16)
#define POS_CALC_DSP_CTNR_TBT_CH01_SHIFT      0
#define POS_CALC_DSP_CTNR_TBT_CH01_W(value)   WBGEN2_DSP_GEN_WRITE(value, 0, 16)
#define POS_CALC_DSP_CTNR_TBT_CH01_R(reg)     WBGEN2_DSP_GEN_READ(reg, 0, 16)

/* definitions for field: TBT incorrect counter for channels 2/3 (multiplexed) in reg: DSP TBT incorrect TDM counter */
#define POS_CALC_DSP_CTNR_TBT_CH23_MASK       WBGEN2_DSP_GEN_MASK(16, 16)
#define POS_CALC_DSP_CTNR_TBT_CH23_SHIFT      16
#define POS_CALC_DSP_CTNR_TBT_CH23_W(value)   WBGEN2_DSP_GEN_WRITE(value, 16, 16)
#define POS_CALC_DSP_CTNR_TBT_CH23_R(reg)     WBGEN2_DSP_GEN_READ(reg, 16, 16)
...
#define POS_CALC_DSP_CTNR_FOFB_CH01_MASK      WBGEN2_DSP_GEN_MASK(0, 16)
#define POS_CALC_DSP_CTNR_FOFB_CH01_SHIFT     0
#define POS_CALC_DSP_CTNR_FOFB_CH01_W(value)  WBGEN2_DSP_GEN_WRITE(value, 0, 16)
#define POS_CALC_DSP_CTNR_FOFB_CH01_R(reg)    WBGEN2_DSP_GEN_READ(reg, 0, 16)

/* definitions for field: FOFB incorrect counter for channels 2/3 (multiplexed) in reg: DSP FOFB incorrect TDM counter */
#define POS_CALC_DSP_CTNR_FOFB_CH23_MASK      WBGEN2_DSP_GEN_MASK(16, 16)
#define POS_CALC_DSP_CTNR_FOFB_CH23_SHIFT     16
#define POS_CALC_DSP_CTNR_FOFB_CH23_W(value)  WBGEN2_DSP_GEN_WRITE(value, 16, 16)
#define POS_CALC_DSP_CTNR_FOFB_CH23_R(reg)    WBGEN2_DSP_GEN_READ(reg, 16, 16)
...
#define POS_CALC_DSP_CTNR1_MONIT_CIC_MASK     WBGEN2_DSP_GEN_MASK(0, 16)
#define POS_CALC_DSP_CTNR1_MONIT_CIC_SHIFT    0
#define POS_CALC_DSP_CTNR1_MONIT_CIC_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 16)
#define POS_CALC_DSP_CTNR1_MONIT_CIC_R(reg)   WBGEN2_DSP_GEN_READ(reg, 0, 16)
...
#define POS_CALC_DSP_CTNR1_MONIT_CFIR_MASK    WBGEN2_DSP_GEN_MASK(16, 16)
#define POS_CALC_DSP_CTNR1_MONIT_CFIR_SHIFT   16
#define POS_CALC_DSP_CTNR1_MONIT_CFIR_W(value) WBGEN2_DSP_GEN_WRITE(value, 16, 16)
#define POS_CALC_DSP_CTNR1_MONIT_CFIR_R(reg)  WBGEN2_DSP_GEN_READ(reg, 16, 16)
...
#define POS_CALC_DSP_CTNR2_MONIT_PFIR_MASK    WBGEN2_DSP_GEN_MASK(0, 16)
#define POS_CALC_DSP_CTNR2_MONIT_PFIR_SHIFT   0
#define POS_CALC_DSP_CTNR2_MONIT_PFIR_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 16)
#define POS_CALC_DSP_CTNR2_MONIT_PFIR_R(reg)  WBGEN2_DSP_GEN_READ(reg, 0, 16)
...
#define POS_CALC_DSP_CTNR2_MONIT_FIR_01_MASK  WBGEN2_DSP_GEN_MASK(16, 16)
#define POS_CALC_DSP_CTNR2_MONIT_FIR_01_SHIFT 16
#define POS_CALC_DSP_CTNR2_MONIT_FIR_01_W(value) WBGEN2_DSP_GEN_WRITE(value, 16, 16)
#define POS_CALC_DSP_CTNR2_MONIT_FIR_01_R(reg) WBGEN2_DSP_GEN_READ(reg, 16, 16)

/* definitions for register: DSP error clearing */

/* definitions for field: Clear TBT error counters in reg: DSP error clearing */
#define POS_CALC_DSP_ERR_CLR_TBT              WBGEN2_DSP_GEN_MASK(0, 1)

/* definitions for field: Clear FOFB error counters in reg: DSP error clearing */
#define POS_CALC_DSP_ERR_CLR_FOFB             WBGEN2_DSP_GEN_MASK(1, 1)

/* definitions for field: Clear Monit. CIC and CFIR error counters in reg: DSP error clearing */
#define POS_CALC_DSP_ERR_CLR_MONIT_PART1      WBGEN2_DSP_GEN_MASK(2, 1)

/* definitions for field: Clear Monit. PFIR and Monit. 0.1 error counters in reg: DSP error clearing */
#define POS_CALC_DSP_ERR_CLR_MONIT_PART2      WBGEN2_DSP_GEN_MASK(3, 1)
...
#define POS_CALC_DDS_CFG_VALID_CH0            WBGEN2_DSP_GEN_MASK(0, 1)

/* definitions for field: Test data counter for all channels in reg: DDS general config registers for all channels */
#define POS_CALC_DDS_CFG_TEST_DATA            WBGEN2_DSP_GEN_MASK(1, 1)

/* definitions for field: Reserved in reg: DDS general config registers for all channels */
#define POS_CALC_DDS_CFG_RESERVED_CH0_MASK    WBGEN2_DSP_GEN_MASK(2, 6)
#define POS_CALC_DDS_CFG_RESERVED_CH0_SHIFT   2
#define POS_CALC_DDS_CFG_RESERVED_CH0_W(value) WBGEN2_DSP_GEN_WRITE(value, 2, 6)
#define POS_CALC_DDS_CFG_RESERVED_CH0_R(reg)  WBGEN2_DSP_GEN_READ(reg, 2, 6)

/* definitions for field: Valid signal for channel 1 DDS in reg: DDS general config registers for all channels */
#define POS_CALC_DDS_CFG_VALID_CH1            WBGEN2_DSP_GEN_MASK(8, 1)

/* definitions for field: Reserved in reg: DDS general config registers for all channels */
#define POS_CALC_DDS_CFG_RESERVED_CH1_MASK    WBGEN2_DSP_GEN_MASK(9, 7)
#define POS_CALC_DDS_CFG_RESERVED_CH1_SHIFT   9
#define POS_CALC_DDS_CFG_RESERVED_CH1_W(value) WBGEN2_DSP_GEN_WRITE(value, 9, 7)
#define POS_CALC_DDS_CFG_RESERVED_CH1_R(reg)  WBGEN2_DSP_GEN_READ(reg, 9, 7)

/* definitions for field: Valid signal for channel 2 DDS in reg: DDS general config registers for all channels */
#define POS_CALC_DDS_CFG_VALID_CH2            WBGEN2_DSP_GEN_MASK(16, 1)

/* definitions for field: Reserved in reg: DDS general config registers for all channels */
#define POS_CALC_DDS_CFG_RESERVED_CH2_MASK    WBGEN2_DSP_GEN_MASK(17, 7)
#define POS_CALC_DDS_CFG_RESERVED_CH2_SHIFT   17
#define POS_CALC_DDS_CFG_RESERVED_CH2_W(value) WBGEN2_DSP_GEN_WRITE(value, 17, 7)
#define POS_CALC_DDS_CFG_RESERVED_CH2_R(reg)  WBGEN2_DSP_GEN_READ(reg, 17, 7)

/* definitions for field: Valid signal for channel 3 DDS in reg: DDS general config registers for all channels */
#define POS_CALC_DDS_CFG_VALID_CH3            WBGEN2_DSP_GEN_MASK(24, 1)

/* definitions for field: Reserved in reg: DDS general config registers for all channels */
#define POS_CALC_DDS_CFG_RESERVED_CH3_MASK    WBGEN2_DSP_GEN_MASK(25, 7)
#define POS_CALC_DDS_CFG_RESERVED_CH3_SHIFT   25
#define POS_CALC_DDS_CFG_RESERVED_CH3_W(value) WBGEN2_DSP_GEN_WRITE(value, 25, 7)
#define POS_CALC_DDS_CFG_RESERVED_CH3_R(reg)  WBGEN2_DSP_GEN_READ(reg, 25, 7)
...
#define POS_CALC_DDS_PINC_CH0_VAL_MASK        WBGEN2_DSP_GEN_MASK(0, 30)
#define POS_CALC_DDS_PINC_CH0_VAL_SHIFT       0
#define POS_CALC_DDS_PINC_CH0_VAL_W(value)    WBGEN2_DSP_GEN_WRITE(value, 0, 30)
#define POS_CALC_DDS_PINC_CH0_VAL_R(reg)      WBGEN2_DSP_GEN_READ(reg, 0, 30)

/* definitions for field: Reserved in reg: DDS phase increment parameter register for channel 0 */
#define POS_CALC_DDS_PINC_CH0_RESERVED_MASK   WBGEN2_DSP_GEN_MASK(30, 2)
#define POS_CALC_DDS_PINC_CH0_RESERVED_SHIFT  30
#define POS_CALC_DDS_PINC_CH0_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 30, 2)
#define POS_CALC_DDS_PINC_CH0_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 30, 2)
...
#define POS_CALC_DDS_PINC_CH1_VAL_MASK        WBGEN2_DSP_GEN_MASK(0, 30)
#define POS_CALC_DDS_PINC_CH1_VAL_SHIFT       0
#define POS_CALC_DDS_PINC_CH1_VAL_W(value)    WBGEN2_DSP_GEN_WRITE(value, 0, 30)
#define POS_CALC_DDS_PINC_CH1_VAL_R(reg)      WBGEN2_DSP_GEN_READ(reg, 0, 30)

/* definitions for field: Reserved in reg: DDS phase increment parameter register for channel 1 */
#define POS_CALC_DDS_PINC_CH1_RESERVED_MASK   WBGEN2_DSP_GEN_MASK(30, 2)
#define POS_CALC_DDS_PINC_CH1_RESERVED_SHIFT  30
#define POS_CALC_DDS_PINC_CH1_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 30, 2)
#define POS_CALC_DDS_PINC_CH1_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 30, 2)
...
#define POS_CALC_DDS_PINC_CH2_VAL_MASK        WBGEN2_DSP_GEN_MASK(0, 30)
#define POS_CALC_DDS_PINC_CH2_VAL_SHIFT       0
#define POS_CALC_DDS_PINC_CH2_VAL_W(value)    WBGEN2_DSP_GEN_WRITE(value, 0, 30)
#define POS_CALC_DDS_PINC_CH2_VAL_R(reg)      WBGEN2_DSP_GEN_READ(reg, 0, 30)

/* definitions for field: Reserved in reg: DDS phase increment parameter register for channel 2 */
#define POS_CALC_DDS_PINC_CH2_RESERVED_MASK   WBGEN2_DSP_GEN_MASK(30, 2)
#define POS_CALC_DDS_PINC_CH2_RESERVED_SHIFT  30
#define POS_CALC_DDS_PINC_CH2_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 30, 2)
#define POS_CALC_DDS_PINC_CH2_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 30, 2)
...
#define POS_CALC_DDS_PINC_CH3_VAL_MASK        WBGEN2_DSP_GEN_MASK(0, 30)
#define POS_CALC_DDS_PINC_CH3_VAL_SHIFT       0
#define POS_CALC_DDS_PINC_CH3_VAL_W(value)    WBGEN2_DSP_GEN_WRITE(value, 0, 30)
#define POS_CALC_DDS_PINC_CH3_VAL_R(reg)      WBGEN2_DSP_GEN_READ(reg, 0, 30)

/* definitions for field: Reserved in reg: DDS phase increment parameter register for channel 3 */
#define POS_CALC_DDS_PINC_CH3_RESERVED_MASK   WBGEN2_DSP_GEN_MASK(30, 2)
#define POS_CALC_DDS_PINC_CH3_RESERVED_SHIFT  30
#define POS_CALC_DDS_PINC_CH3_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 30, 2)
#define POS_CALC_DDS_PINC_CH3_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 30, 2)
...
#define POS_CALC_DDS_POFF_CH0_VAL_MASK        WBGEN2_DSP_GEN_MASK(0, 30)
#define POS_CALC_DDS_POFF_CH0_VAL_SHIFT       0
#define POS_CALC_DDS_POFF_CH0_VAL_W(value)    WBGEN2_DSP_GEN_WRITE(value, 0, 30)
#define POS_CALC_DDS_POFF_CH0_VAL_R(reg)      WBGEN2_DSP_GEN_READ(reg, 0, 30)

/* definitions for field: Reserved in reg: DDS phase offset parameter register for channel 0 */
#define POS_CALC_DDS_POFF_CH0_RESERVED_MASK   WBGEN2_DSP_GEN_MASK(30, 2)
#define POS_CALC_DDS_POFF_CH0_RESERVED_SHIFT  30
#define POS_CALC_DDS_POFF_CH0_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 30, 2)
#define POS_CALC_DDS_POFF_CH0_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 30, 2)
...
#define POS_CALC_DDS_POFF_CH1_VAL_MASK        WBGEN2_DSP_GEN_MASK(0, 30)
#define POS_CALC_DDS_POFF_CH1_VAL_SHIFT       0
#define POS_CALC_DDS_POFF_CH1_VAL_W(value)    WBGEN2_DSP_GEN_WRITE(value, 0, 30)
#define POS_CALC_DDS_POFF_CH1_VAL_R(reg)      WBGEN2_DSP_GEN_READ(reg, 0, 30)

/* definitions for field: Reserved in reg: DDS phase offset parameter register for channel 1 */
#define POS_CALC_DDS_POFF_CH1_RESERVED_MASK   WBGEN2_DSP_GEN_MASK(30, 2)
#define POS_CALC_DDS_POFF_CH1_RESERVED_SHIFT  30
#define POS_CALC_DDS_POFF_CH1_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 30, 2)
#define POS_CALC_DDS_POFF_CH1_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 30, 2)
...
#define POS_CALC_DDS_POFF_CH2_VAL_MASK        WBGEN2_DSP_GEN_MASK(0, 30)
#define POS_CALC_DDS_POFF_CH2_VAL_SHIFT       0
#define POS_CALC_DDS_POFF_CH2_VAL_W(value)    WBGEN2_DSP_GEN_WRITE(value, 0, 30)
#define POS_CALC_DDS_POFF_CH2_VAL_R(reg)      WBGEN2_DSP_GEN_READ(reg, 0, 30)

/* definitions for field: Reserved in reg: DDS phase offset parameter register for channel 2 */
#define POS_CALC_DDS_POFF_CH2_RESERVED_MASK   WBGEN2_DSP_GEN_MASK(30, 2)
#define POS_CALC_DDS_POFF_CH2_RESERVED_SHIFT  30
#define POS_CALC_DDS_POFF_CH2_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 30, 2)
#define POS_CALC_DDS_POFF_CH2_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 30, 2)
...
#define POS_CALC_DDS_POFF_CH3_VAL_MASK        WBGEN2_DSP_GEN_MASK(0, 30)
#define POS_CALC_DDS_POFF_CH3_VAL_SHIFT       0
#define POS_CALC_DDS_POFF_CH3_VAL_W(value)    WBGEN2_DSP_GEN_WRITE(value, 0, 30)
#define POS_CALC_DDS_POFF_CH3_VAL_R(reg)      WBGEN2_DSP_GEN_READ(reg, 0, 30)

/* definitions for field: Reserved in reg: DDS phase offset parameter register for channel 3 */
#define POS_CALC_DDS_POFF_CH3_RESERVED_MASK   WBGEN2_DSP_GEN_MASK(30, 2)
#define POS_CALC_DDS_POFF_CH3_RESERVED_SHIFT  30
#define POS_CALC_DDS_POFF_CH3_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 30, 2)
#define POS_CALC_DDS_POFF_CH3_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 30, 2)
...
#define POS_CALC_AMPFIFO_MONIT_R0_AMP_CH0_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_AMPFIFO_MONIT_R0_AMP_CH0_SHIFT 0
#define POS_CALC_AMPFIFO_MONIT_R0_AMP_CH0_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_AMPFIFO_MONIT_R0_AMP_CH0_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_AMPFIFO_MONIT_R1_AMP_CH1_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_AMPFIFO_MONIT_R1_AMP_CH1_SHIFT 0
#define POS_CALC_AMPFIFO_MONIT_R1_AMP_CH1_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_AMPFIFO_MONIT_R1_AMP_CH1_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_AMPFIFO_MONIT_R2_AMP_CH2_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_AMPFIFO_MONIT_R2_AMP_CH2_SHIFT 0
#define POS_CALC_AMPFIFO_MONIT_R2_AMP_CH2_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_AMPFIFO_MONIT_R2_AMP_CH2_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_AMPFIFO_MONIT_R3_AMP_CH3_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_AMPFIFO_MONIT_R3_AMP_CH3_SHIFT 0
#define POS_CALC_AMPFIFO_MONIT_R3_AMP_CH3_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_AMPFIFO_MONIT_R3_AMP_CH3_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_AMPFIFO_MONIT_CSR_FULL       WBGEN2_DSP_GEN_MASK(16, 1)

/* definitions for field: FIFO empty flag in reg: FIFO 'AMP FIFO Monitoring' control/status register */
#define POS_CALC_AMPFIFO_MONIT_CSR_EMPTY      WBGEN2_DSP_GEN_MASK(17, 1)

/* definitions for field: FIFO counter in reg: FIFO 'AMP FIFO Monitoring' control/status register */
#define POS_CALC_AMPFIFO_MONIT_CSR_USEDW_MASK WBGEN2_DSP_GEN_MASK(0, 4)
#define POS_CALC_AMPFIFO_MONIT_CSR_USEDW_SHIFT 0
#define POS_CALC_AMPFIFO_MONIT_CSR_USEDW_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 4)
#define POS_CALC_AMPFIFO_MONIT_CSR_USEDW_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 4)
...
#define POS_CALC_POSFIFO_MONIT_R0_POS_X_MASK  WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_POSFIFO_MONIT_R0_POS_X_SHIFT 0
#define POS_CALC_POSFIFO_MONIT_R0_POS_X_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_POSFIFO_MONIT_R0_POS_X_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_POSFIFO_MONIT_R1_POS_Y_MASK  WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_POSFIFO_MONIT_R1_POS_Y_SHIFT 0
#define POS_CALC_POSFIFO_MONIT_R1_POS_Y_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_POSFIFO_MONIT_R1_POS_Y_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_POSFIFO_MONIT_R2_POS_Q_MASK  WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_POSFIFO_MONIT_R2_POS_Q_SHIFT 0
#define POS_CALC_POSFIFO_MONIT_R2_POS_Q_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_POSFIFO_MONIT_R2_POS_Q_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_POSFIFO_MONIT_R3_POS_SUM_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_POSFIFO_MONIT_R3_POS_SUM_SHIFT 0
#define POS_CALC_POSFIFO_MONIT_R3_POS_SUM_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_POSFIFO_MONIT_R3_POS_SUM_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_POSFIFO_MONIT_CSR_FULL       WBGEN2_DSP_GEN_MASK(16, 1)

/* definitions for field: FIFO empty flag in reg: FIFO 'POS FIFO Monitoring' control/status register */
#define POS_CALC_POSFIFO_MONIT_CSR_EMPTY      WBGEN2_DSP_GEN_MASK(17, 1)

/* definitions for field: FIFO counter in reg: FIFO 'POS FIFO Monitoring' control/status register */
#define POS_CALC_POSFIFO_MONIT_CSR_USEDW_MASK WBGEN2_DSP_GEN_MASK(0, 4)
#define POS_CALC_POSFIFO_MONIT_CSR_USEDW_SHIFT 0
#define POS_CALC_POSFIFO_MONIT_CSR_USEDW_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 4)
#define POS_CALC_POSFIFO_MONIT_CSR_USEDW_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 4)
...
#define POS_CALC_AMPFIFO_MONIT1_R0_AMP_CH0_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_AMPFIFO_MONIT1_R0_AMP_CH0_SHIFT 0
#define POS_CALC_AMPFIFO_MONIT1_R0_AMP_CH0_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_AMPFIFO_MONIT1_R0_AMP_CH0_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_AMPFIFO_MONIT1_R1_AMP_CH1_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_AMPFIFO_MONIT1_R1_AMP_CH1_SHIFT 0
#define POS_CALC_AMPFIFO_MONIT1_R1_AMP_CH1_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_AMPFIFO_MONIT1_R1_AMP_CH1_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_AMPFIFO_MONIT1_R2_AMP_CH2_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_AMPFIFO_MONIT1_R2_AMP_CH2_SHIFT 0
#define POS_CALC_AMPFIFO_MONIT1_R2_AMP_CH2_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_AMPFIFO_MONIT1_R2_AMP_CH2_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_AMPFIFO_MONIT1_R3_AMP_CH3_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_AMPFIFO_MONIT1_R3_AMP_CH3_SHIFT 0
#define POS_CALC_AMPFIFO_MONIT1_R3_AMP_CH3_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_AMPFIFO_MONIT1_R3_AMP_CH3_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_AMPFIFO_MONIT1_CSR_FULL      WBGEN2_DSP_GEN_MASK(16, 1)

/* definitions for field: FIFO empty flag in reg: FIFO 'AMP FIFO Monitoring 1' control/status register */
#define POS_CALC_AMPFIFO_MONIT1_CSR_EMPTY     WBGEN2_DSP_GEN_MASK(17, 1)

/* definitions for field: FIFO counter in reg: FIFO 'AMP FIFO Monitoring 1' control/status register */
#define POS_CALC_AMPFIFO_MONIT1_CSR_USEDW_MASK WBGEN2_DSP_GEN_MASK(0, 4)
#define POS_CALC_AMPFIFO_MONIT1_CSR_USEDW_SHIFT 0
#define POS_CALC_AMPFIFO_MONIT1_CSR_USEDW_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 4)
#define POS_CALC_AMPFIFO_MONIT1_CSR_USEDW_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 4)
...
#define POS_CALC_POSFIFO_MONIT1_R0_POS_X_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_POSFIFO_MONIT1_R0_POS_X_SHIFT 0
#define POS_CALC_POSFIFO_MONIT1_R0_POS_X_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_POSFIFO_MONIT1_R0_POS_X_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_POSFIFO_MONIT1_R1_POS_Y_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_POSFIFO_MONIT1_R1_POS_Y_SHIFT 0
#define POS_CALC_POSFIFO_MONIT1_R1_POS_Y_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_POSFIFO_MONIT1_R1_POS_Y_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_POSFIFO_MONIT1_R2_POS_Q_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_POSFIFO_MONIT1_R2_POS_Q_SHIFT 0
#define POS_CALC_POSFIFO_MONIT1_R2_POS_Q_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_POSFIFO_MONIT1_R2_POS_Q_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_POSFIFO_MONIT1_R3_POS_SUM_MASK WBGEN2_DSP_GEN_MASK(0, 32)
#define POS_CALC_POSFIFO_MONIT1_R3_POS_SUM_SHIFT 0
#define POS_CALC_POSFIFO_MONIT1_R3_POS_SUM_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 32)
#define POS_CALC_POSFIFO_MONIT1_R3_POS_SUM_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 32)
...
#define POS_CALC_POSFIFO_MONIT1_CSR_FULL      WBGEN2_DSP_GEN_MASK(16, 1)

/* definitions for field: FIFO empty flag in reg: FIFO 'POS FIFO Monitoring 1' control/status register */
#define POS_CALC_POSFIFO_MONIT1_CSR_EMPTY     WBGEN2_DSP_GEN_MASK(17, 1)

/* definitions for field: FIFO counter in reg: FIFO 'POS FIFO Monitoring 1' control/status register */
#define POS_CALC_POSFIFO_MONIT1_CSR_USEDW_MASK WBGEN2_DSP_GEN_MASK(0, 4)
...
#define POS_CALC_SW_TAG_DESYNC_CNT_RST        WBGEN2_DSP_GEN_MASK(8, 1)

/* definitions for field: Switching Desynchronization Counter in reg: Switching Tag synchronization */
#define POS_CALC_SW_TAG_DESYNC_CNT_MASK       WBGEN2_DSP_GEN_MASK(9, 14)
#define POS_CALC_SW_TAG_DESYNC_CNT_SHIFT      9
#define POS_CALC_SW_TAG_DESYNC_CNT_W(value)   WBGEN2_DSP_GEN_WRITE(value, 9, 14)
#define POS_CALC_SW_TAG_DESYNC_CNT_R(reg)     WBGEN2_DSP_GEN_READ(reg, 9, 14)
...
#define POS_CALC_TBT_TAG_EN             WBGEN2_DSP_GEN_MASK(0, 1)

/* definitions for field: TbT Synchronizing Trigger Delay in reg: TbT Synchronizing Trigger */
#define POS_CALC_TBT_TAG_DLY_MASK       WBGEN2_DSP_GEN_MASK(1, 16)
#define POS_CALC_TBT_TAG_DLY_SHIFT      1
#define POS_CALC_TBT_TAG_DLY_W(value)   WBGEN2_DSP_GEN_WRITE(value, 1, 16)
#define POS_CALC_TBT_TAG_DLY_R(reg)     WBGEN2_DSP_GEN_READ(reg, 1, 16)

/* definitions for field: TbT Desynchronization Counter Reset in reg: TbT Synchronizing Trigger */
#define POS_CALC_TBT_TAG_DESYNC_CNT_RST       WBGEN2_DSP_GEN_MASK(17, 1)

/* definitions for field: TbT Desynchronization Counter in reg: TbT Synchronizing Trigger */
#define POS_CALC_TBT_TAG_DESYNC_CNT_MASK      WBGEN2_DSP_GEN_MASK(18, 14)
#define POS_CALC_TBT_TAG_DESYNC_CNT_SHIFT     18
#define POS_CALC_TBT_TAG_DESYNC_CNT_W(value)  WBGEN2_DSP_GEN_WRITE(value, 18, 14)
#define POS_CALC_TBT_TAG_DESYNC_CNT_R(reg)    WBGEN2_DSP_GEN_READ(reg, 18, 14)
/* definitions for register: TbT Masking Control */

/* definitions for field: TbT Masking Enable in reg: TbT Masking Control */
#define POS_CALC_TBT_DATA_MASK_CTL_EN         WBGEN2_DSP_GEN_MASK(0, 1)
...
#define POS_CALC_TBT_DATA_MASK_SAMPLES_BEG_MASK WBGEN2_DSP_GEN_MASK(0, 16)
#define POS_CALC_TBT_DATA_MASK_SAMPLES_BEG_SHIFT 0
#define POS_CALC_TBT_DATA_MASK_SAMPLES_BEG_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 16)
#define POS_CALC_TBT_DATA_MASK_SAMPLES_BEG_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 16)

/* definitions for field: TbT Beginning Data Masking Samples in reg: TbT Data Masking Samples */
#define POS_CALC_TBT_DATA_MASK_SAMPLES_END_MASK WBGEN2_DSP_GEN_MASK(16, 16)
...
#define POS_CALC_REG_AMP_GAIN_CH0_DATA_MASK WBGEN2_DSP_GEN_MASK(0, 25)
#define POS_CALC_REG_AMP_GAIN_CH0_DATA_SHIFT 0
#define POS_CALC_REG_AMP_GAIN_CH0_DATA_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 25)
#define POS_CALC_REG_AMP_GAIN_CH0_DATA_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 25)

/* definitions for field: RESERVED in reg: Amplitude gain for channel 0 */
#define POS_CALC_REG_AMP_GAIN_CH0_RESERVED_MASK WBGEN2_DSP_GEN_MASK(25, 7)
#define POS_CALC_REG_AMP_GAIN_CH0_RESERVED_SHIFT 25
#define POS_CALC_REG_AMP_GAIN_CH0_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 25, 7)
#define POS_CALC_REG_AMP_GAIN_CH0_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 25, 7)

/* definitions for field: DATA in reg: Amplitude gain for channel 1 */
#define POS_CALC_REG_AMP_GAIN_CH1_DATA_MASK WBGEN2_DSP_GEN_MASK(0, 25)
#define POS_CALC_REG_AMP_GAIN_CH1_DATA_SHIFT 0
#define POS_CALC_REG_AMP_GAIN_CH1_DATA_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 25)
#define POS_CALC_REG_AMP_GAIN_CH1_DATA_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 25)

/* definitions for field: RESERVED in reg: Amplitude gain for channel 1 */
#define POS_CALC_REG_AMP_GAIN_CH1_RESERVED_MASK WBGEN2_DSP_GEN_MASK(25, 7)
#define POS_CALC_REG_AMP_GAIN_CH1_RESERVED_SHIFT 25
#define POS_CALC_REG_AMP_GAIN_CH1_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 25, 7)
#define POS_CALC_REG_AMP_GAIN_CH1_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 25, 7)

/* definitions for field: DATA in reg: Amplitude gain for channel 2 */
#define POS_CALC_REG_AMP_GAIN_CH2_DATA_MASK WBGEN2_DSP_GEN_MASK(0, 25)
#define POS_CALC_REG_AMP_GAIN_CH2_DATA_SHIFT 0
#define POS_CALC_REG_AMP_GAIN_CH2_DATA_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 25)
#define POS_CALC_REG_AMP_GAIN_CH2_DATA_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 25)

/* definitions for field: RESERVED in reg: Amplitude gain for channel 2 */
#define POS_CALC_REG_AMP_GAIN_CH2_RESERVED_MASK WBGEN2_DSP_GEN_MASK(25, 7)
#define POS_CALC_REG_AMP_GAIN_CH2_RESERVED_SHIFT 25
#define POS_CALC_REG_AMP_GAIN_CH2_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 25, 7)
#define POS_CALC_REG_AMP_GAIN_CH2_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 25, 7)

/* definitions for field: DATA in reg: Amplitude gain for channel 3 */
#define POS_CALC_REG_AMP_GAIN_CH3_DATA_MASK WBGEN2_DSP_GEN_MASK(0, 25)
#define POS_CALC_REG_AMP_GAIN_CH3_DATA_SHIFT 0
#define POS_CALC_REG_AMP_GAIN_CH3_DATA_W(value) WBGEN2_DSP_GEN_WRITE(value, 0, 25)
#define POS_CALC_REG_AMP_GAIN_CH3_DATA_R(reg) WBGEN2_DSP_GEN_READ(reg, 0, 25)

/* definitions for field: RESERVED in reg: Amplitude gain for channel 3 */
#define POS_CALC_REG_AMP_GAIN_CH3_RESERVED_MASK WBGEN2_DSP_GEN_MASK(25, 7)
#define POS_CALC_REG_AMP_GAIN_CH3_RESERVED_SHIFT 25
#define POS_CALC_REG_AMP_GAIN_CH3_RESERVED_W(value) WBGEN2_DSP_GEN_WRITE(value, 25, 7)
#define POS_CALC_REG_AMP_GAIN_CH3_RESERVED_R(reg) WBGEN2_DSP_GEN_READ(reg, 25, 7)
