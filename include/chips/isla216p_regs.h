...
#define ISLA216P_PORTCONFIG_SDO_ACTIVE_SIZE         1
#define ISLA216P_PORTCONFIG_SDO_ACTIVE_SHIFT        0
#define ISLA216P_PORTCONFIG_SDO_ACTIVE              WBGEN2_GEN_MASK(ISLA216P_PORTCONFIG_SDO_ACTIVE_SHIFT, \
                                                            ISLA216P_PORTCONFIG_SDO_ACTIVE_SIZE)

#define ISLA216P_PORTCONFIG_LSB_FIRST_SIZE          1
#define ISLA216P_PORTCONFIG_LSB_FIRST_SHIFT         1
#define ISLA216P_PORTCONFIG_LSB_FIRST               WBGEN2_GEN_MASK(ISLA216P_PORTCONFIG_LSB_FIRST_SHIFT, \
                                                             ISLA216P_PORTCONFIG_LSB_FIRST_SIZE)

#define ISLA216P_PORTCONFIG_SOFT_RESET_SIZE         1
#define ISLA216P_PORTCONFIG_SOFT_RESET_SHIFT        2
#define ISLA216P_PORTCONFIG_SOFT_RESET              WBGEN2_GEN_MASK(ISLA216P_PORTCONFIG_SOFT_RESET_SHIFT, \
                                                            ISLA216P_PORTCONFIG_SOFT_RESET_SIZE)
