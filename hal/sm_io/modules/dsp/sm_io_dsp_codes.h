...
#define DSP_NAME_SET_GET_MONIT_AMP_CH0      "set_get_monit_amp_ch0"
#define DSP_OPCODE_SET_GET_MONIT_AMP_CH1    7
#define DSP_NAME_SET_GET_MONIT_AMP_CH1      "set_get_monit_amp_ch1"
#define DSP_OPCODE_SET_GET_MONIT_AMP_CH2    8
#define DSP_NAME_SET_GET_MONIT_AMP_CH2      "set_get_monit_amp_ch2"
#define DSP_OPCODE_SET_GET_MONIT_AMP_CH3    9
#define DSP_NAME_SET_GET_MONIT_AMP_CH3      "set_get_monit_amp_ch3"
#define DSP_OPCODE_SET_GET_MONIT_POS_X      10
#define DSP_NAME_SET_GET_MONIT_POS_X        "set_get_monit_pos_x"
#define DSP_OPCODE_SET_GET_MONIT_POS_Y      11
#define DSP_NAME_SET_GET_MONIT_POS_Y        "set_get_monit_pos_y"
#define DSP_OPCODE_SET_GET_MONIT_POS_Q      12
#define DSP_NAME_SET_GET_MONIT_POS_Q        "set_get_monit_pos_q"
#define DSP_OPCODE_SET_GET_MONIT_POS_SUM    13
#define DSP_NAME_SET_GET_MONIT_POS_SUM      "set_get_monit_pos_sum"
