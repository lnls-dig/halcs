...
#define __HALCS_CLIENT_ERR_MODULE 153202234

#define __HALCS_CLIENT_ERR_MODULE_ERR1  (__HALCS_CLIENT_ERR_MODULE + 1)
#define __HALCS_CLIENT_ERR_MODULE_ERR2  (__HALCS_CLIENT_ERR_MODULE + 2)
#define __HALCS_CLIENT_ERR_MODULE_ERR3  (__HALCS_CLIENT_ERR_MODULE + 3)
#define __HALCS_CLIENT_ERR_MODULE_ERR4  (__HALCS_CLIENT_ERR_MODULE + 4)
#define __HALCS_CLIENT_ERR_MODULE_ERR5  (__HALCS_CLIENT_ERR_MODULE + 5)
#define __HALCS_CLIENT_ERR_MODULE_ERR6  (__HALCS_CLIENT_ERR_MODULE + 6)
#define __HALCS_CLIENT_ERR_MODULE_ERR7  (__HALCS_CLIENT_ERR_MODULE + 7)
#define __HALCS_CLIENT_ERR_MODULE_ERR8  (__HALCS_CLIENT_ERR_MODULE + 8)
#define __HALCS_CLIENT_ERR_MODULE_ERR9  (__HALCS_CLIENT_ERR_MODULE + 9)
#define __HALCS_CLIENT_ERR_MODULE_ERR10 (__HALCS_CLIENT_ERR_MODULE + 10)
#define __HALCS_CLIENT_ERR_MODULE_ERR11 (__HALCS_CLIENT_ERR_MODULE + 11)
#define __HALCS_CLIENT_ERR_MODULE_ERR12 (__HALCS_CLIENT_ERR_MODULE + 12)
#define __HALCS_CLIENT_ERR_MODULE_ERR13 (__HALCS_CLIENT_ERR_MODULE + 13)
#define __HALCS_CLIENT_ERR_MODULE_ERR14 (__HALCS_CLIENT_ERR_MODULE + 14)
#define __HALCS_CLIENT_ERR_MODULE_ERR15 (__HALCS_CLIENT_ERR_MODULE + 15)
#define __HALCS_CLIENT_ERR_MODULE_ERR16 (__HALCS_CLIENT_ERR_MODULE + 16)
#define __HALCS_CLIENT_ERR_MODULE_ERR17 (__HALCS_CLIENT_ERR_MODULE + 17)
#define __HALCS_CLIENT_ERR_MODULE_ERR18 (__HALCS_CLIENT_ERR_MODULE + 18)
#define __HALCS_CLIENT_ERR_MODULE_ERR19 (__HALCS_CLIENT_ERR_MODULE + 19)
#define __HALCS_CLIENT_ERR_MODULE_ERR20 (__HALCS_CLIENT_ERR_MODULE + 20)
...
enum _halcs_client_err_e
{
    ...
    HALCS_CLIENT_ERR_MODULE = __HALCS_CLIENT_ERR_MODULE,    /* Random number to separate halcs_client codes from module's codes */
