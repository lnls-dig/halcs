...
disp_op_t fofb_ctrl_set_get_link_partner_exp = {
    .name = FOFB_CTRL_NAME_SET_GET_LINK_PARTNER,
    .opcode = FOFB_CTRL_OPCODE_SET_GET_LINK_PARTNER,
    .retval = DISP_ARG_ENCODE(DISP_ATYPE_UINT32, uint32_t),
    .retval_owner = DISP_OWNER_OTHER,
    .args = {
        DISP_ARG_ENCODE(DISP_ATYPE_UINT32, uint32_t),
...
disp_op_t fofb_ctrl_set_get_hard_err_cnt_exp = {
    .name = FOFB_CTRL_NAME_SET_GET_HARD_ERR_CNT,
    .opcode = FOFB_CTRL_OPCODE_SET_GET_HARD_ERR_CNT,
    .retval = DISP_ARG_ENCODE(DISP_ATYPE_UINT32, uint32_t),
    .retval_owner = DISP_OWNER_OTHER,
    .args = {
        DISP_ARG_ENCODE(DISP_ATYPE_UINT32, uint32_t),
...
disp_op_t fofb_ctrl_set_get_soft_err_cnt_exp = {
    .name = FOFB_CTRL_NAME_SET_GET_SOFT_ERR_CNT,
    .opcode = FOFB_CTRL_OPCODE_SET_GET_SOFT_ERR_CNT,
    .retval = DISP_ARG_ENCODE(DISP_ATYPE_UINT32, uint32_t),
    .retval_owner = DISP_OWNER_OTHER,
    .args = {
        DISP_ARG_ENCODE(DISP_ATYPE_UINT32, uint32_t),
...
disp_op_t fofb_ctrl_set_get_frame_err_cnt_exp = {
    .name = FOFB_CTRL_NAME_SET_GET_FRAME_ERR_CNT,
    .opcode = FOFB_CTRL_OPCODE_SET_GET_FRAME_ERR_CNT,
    .retval = DISP_ARG_ENCODE(DISP_ATYPE_UINT32, uint32_t),
    .retval_owner = DISP_OWNER_OTHER,
    .args = {
        DISP_ARG_ENCODE(DISP_ATYPE_UINT32, uint32_t),
...
disp_op_t fofb_ctrl_set_get_rx_pck_cnt_exp = {
    .name = FOFB_CTRL_NAME_SET_GET_RX_PCK_CNT,
    .opcode = FOFB_CTRL_OPCODE_SET_GET_RX_PCK_CNT,
    .retval = DISP_ARG_ENCODE(DISP_ATYPE_UINT32, uint32_t),
    .retval_owner = DISP_OWNER_OTHER,
    .args = {
        DISP_ARG_ENCODE(DISP_ATYPE_UINT32, uint32_t),
...
disp_op_t fofb_ctrl_set_get_tx_pck_cnt_exp = {
    .name = FOFB_CTRL_NAME_SET_GET_TX_PCK_CNT,
    .opcode = FOFB_CTRL_OPCODE_SET_GET_TX_PCK_CNT,
    .retval = DISP_ARG_ENCODE(DISP_ATYPE_UINT32, uint32_t),
    .retval_owner = DISP_OWNER_OTHER,
    .args = {
        DISP_ARG_ENCODE(DISP_ATYPE_UINT32, uint32_t),
...
const disp_op_t *fofb_ctrl_exp_ops [] = {
    ...
    &fofb_ctrl_set_get_link_partner_exp,
    &fofb_ctrl_set_get_link_up_exp,
    &fofb_ctrl_set_get_time_frame_count_exp,
    &fofb_ctrl_set_get_hard_err_cnt_exp,
    &fofb_ctrl_set_get_soft_err_cnt_exp,
    &fofb_ctrl_set_get_frame_err_cnt_exp,
    &fofb_ctrl_set_get_rx_pck_cnt_exp,
    &fofb_ctrl_set_get_tx_pck_cnt_exp,
