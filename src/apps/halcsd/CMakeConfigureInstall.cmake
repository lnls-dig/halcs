...
if(NOT DEFINED HALCS_LOG_DIR)
    message(FATAL_ERROR "${CMAKE_CURRENT_LIST_FILE}(${CMAKE_CURRENT_LIST_LINE}): error: Variable HALCS_LOG_DIR is not defined.")
endif()
...
set(halcsd_HALCS_FULL_LOG_DIR "${HALCS_LOG_DIR}")
