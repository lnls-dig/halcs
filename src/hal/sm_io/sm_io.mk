include $(SRC_DIR)/hal/sm_io/modules/modules.mk
include $(SRC_DIR)/hal/sm_io/rw_param/rw_param.mk
include $(SRC_DIR)/hal/sm_io/protocols/protocols.mk
include $(SRC_DIR)/hal/sm_io/chips/chips.mk

sm_io_DIR = $(SRC_DIR)/hal/sm_io
