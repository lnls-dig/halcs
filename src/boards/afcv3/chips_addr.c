...
const uint32_t fmc130m_4ch_si571_addr[__NUM_FMC130M_4CH_SMIOS] = {0x49, 0x49};
const uint32_t fmc130m_4ch_ad9510_addr[__NUM_FMC130M_4CH_SMIOS] = {0x01, 0x01};

/* The FMC EEPROM was supposed to have address 0x50 and 0x52, but GA1 and GA0
 * are all grounded on hardware */
const uint32_t fmc130m_4ch_24aa64_addr[__NUM_FMC130M_4CH_SMIOS] = {0x50, 0x50};
...
const uint32_t fmc130m_4ch_pca9547_addr[__NUM_FMC130M_4CH_SMIOS] = {0x70, 0x70};

/* FMC250M_4CH chip addresses */
const uint32_t fmc250m_4ch_si571_addr[__NUM_FMC250M_4CH_SMIOS] = {0x49, 0x49};
const uint32_t fmc250m_4ch_ad9510_addr[__NUM_FMC250M_4CH_SMIOS] = {0x01, 0x01};

/* The FMC EEPROM was supposed to have address 0x50 and 0x52, but GA1 and GA0
 * are all grounded on hardware */
const uint32_t fmc250m_4ch_24aa64_addr[__NUM_FMC250M_4CH_SMIOS] = {0x50, 0x50};

const uint32_t fmc250m_4ch_amc7823_addr[__NUM_FMC250M_4CH_SMIOS] = {0x01, 0x01};
...
const uint32_t fmc250m_4ch_pca9547_addr[__NUM_FMC250M_4CH_SMIOS] = {0x70, 0x70};
