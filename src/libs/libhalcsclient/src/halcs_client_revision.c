...
#define HALCS_CLIENT_VERSION_MAJOR_STR STRINGIFY(HALCS_CLIENT_VERSION_MAJOR)
#define HALCS_CLIENT_VERSION_MINOR_STR STRINGIFY(HALCS_CLIENT_VERSION_MINOR)
#define HALCS_CLIENT_VERSION_PATCH_STR STRINGIFY(HALCS_CLIENT_VERSION_PATCH)
...
static const char *build_version = HALCS_CLIENT_VERSION_MAJOR_STR"."HALCS_CLIENT_VERSION_MINOR_STR"."HALCS_CLIENT_VERSION_PATCH_STR;
