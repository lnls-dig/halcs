/*
  ...
  * Created        : Wed Jun  6 13:20:57 2018
  * Standard       : ANSI C
...
#define TIMING_DDMTD_AVG_EXP_MASK             WBGEN2_GEN_MASK(0, 12)
#define TIMING_DDMTD_AVG_EXP_SHIFT            0
#define TIMING_DDMTD_AVG_EXP_W(value)         WBGEN2_GEN_WRITE(value, 0, 12)
#define TIMING_DDMTD_AVG_EXP_R(reg)           WBGEN2_GEN_READ(reg, 0, 12)
...
/* definitions for register: Phase feedback setpoint register */
...
/* definitions for register: Event code 7 */
...
/* definitions for register: Event delay 7 */
...
/* definitions for register: Event width 7 */
...
/* [0x28]: REG Phase feedback setpoint register */
#define TIMING_REG_PHASE_SET 0x00000028
...
/* [0x48]: REG Event code 7 */
#define TIMING_REG_EVT_IN7 0x00000048
/* [0x4c]: REG Event delay 0 */
#define TIMING_REG_EVT_DLY0 0x0000004c
/* [0x50]: REG Event delay 1 */
#define TIMING_REG_EVT_DLY1 0x00000050
/* [0x54]: REG Event delay 2 */
#define TIMING_REG_EVT_DLY2 0x00000054
/* [0x58]: REG Event delay 3 */
#define TIMING_REG_EVT_DLY3 0x00000058
/* [0x5c]: REG Event delay 4 */
#define TIMING_REG_EVT_DLY4 0x0000005c
/* [0x60]: REG Event delay 5 */
#define TIMING_REG_EVT_DLY5 0x00000060
/* [0x64]: REG Event delay 6 */
#define TIMING_REG_EVT_DLY6 0x00000064
/* [0x68]: REG Event delay 7 */
#define TIMING_REG_EVT_DLY7 0x00000068
/* [0x6c]: REG Event width 0 */
#define TIMING_REG_EVT_WDT0 0x0000006c
/* [0x70]: REG Event width 1 */
#define TIMING_REG_EVT_WDT1 0x00000070
/* [0x74]: REG Event width 2 */
#define TIMING_REG_EVT_WDT2 0x00000074
/* [0x78]: REG Event width 3 */
#define TIMING_REG_EVT_WDT3 0x00000078
/* [0x7c]: REG Event width 4 */
#define TIMING_REG_EVT_WDT4 0x0000007c
/* [0x80]: REG Event width 5 */
#define TIMING_REG_EVT_WDT5 0x00000080
/* [0x84]: REG Event width 6 */
#define TIMING_REG_EVT_WDT6 0x00000084
/* [0x88]: REG Event width 7 */
#define TIMING_REG_EVT_WDT7 0x00000088
#endif
