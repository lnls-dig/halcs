/*
  ...
  * Created        : Mon Mar 25 15:25:50 2019
  * Standard       : ANSI C
...
#define POS_CALC_SYNC_TBT_TRIG_EN             WBGEN2_DSP_GEN_MASK(0, 1)

/* definitions for field: TbT Synchronizing Trigger Delay in reg: TbT Synchronizing Trigger */
#define POS_CALC_SYNC_TBT_TRIG_DLY_MASK       WBGEN2_DSP_GEN_MASK(1, 16)
#define POS_CALC_SYNC_TBT_TRIG_DLY_SHIFT      1
#define POS_CALC_SYNC_TBT_TRIG_DLY_W(value)   WBGEN2_DSP_GEN_WRITE(value, 1, 16)
#define POS_CALC_SYNC_TBT_TRIG_DLY_R(reg)     WBGEN2_DSP_GEN_READ(reg, 1, 16)
