...
#define ASSERT_TEST(test_boolean, err_str, err_goto_label, /* err_core */ ...)  \
    ASSERT_HAL_TEST(test_boolean, SM_IO, "[sm_io:tim_rcv_defaults]",            \
...
#define ASSERT_ALLOC(ptr, err_goto_label, /* err_core */ ...)                   \
    ASSERT_HAL_ALLOC(ptr, SM_IO, "[sm_io:tim_rcv_defaults]",                    \
...
#define CHECK_ERR(err, err_type)                                                \
    CHECK_HAL_ERR(err, SM_IO, "[sm_io:tim_rcv_defaults]",                       \
            smio_err_str (err_type))

#define SMIO_TIM_RCV_LIBHALCSCLIENT_LOG_MODE                "a"
       ...
       const char *log_file_name)
{
    ...
    DBE_DEBUG (DBG_SM_IO | DBG_LVL_INFO, "[sm_io:tim_rcv_defaults] Configuring SMIO "
            "TIM_RCV with default values ...\n");
